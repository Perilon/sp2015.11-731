...
#incomplete_childrel_ft_strings = []
#incomplete_childPOS_ft_strings = []
...
len_all = len_prev + len_Next + len_root_ft_strings_1 + len_prev_POS + len_Next_POS + len_parentrel + len_parentPOS
...
w = np.append(np.append(np.append(np.append(np.append(np.append(np.append(w_first_part, zeros_prev), zeros_Next), zeros_other), zeros_prev_POS), zeros_Next_POS), zeros_parentrel), zeros_parentPOS)
...
for iters in range(iterations):
	...
	for line in open(args.input):
		...
		y = np.append(np.append(np.append(np.append(np.append(np.append(np.append(y_first_part, zeros_prev), zeros_Next), zeros_other), zeros_prev_POS), zeros_Next_POS), zeros_parentrel), zeros_parentPOS)
		#print "y = ", y
	...
	#incorrect_translations[incorrect_czech_word]["log_lex_prob_tgs"], incorrect_translations[incorrect_czech_word]["log_lex_prob_sgt"]
			...
			x[n] = np.append(np.append(np.append(np.append(np.append(np.append(np.append(temp_array, zeros_prev), zeros_Next), zeros_other), zeros_prev_POS), zeros_Next_POS), zeros_parentrel), zeros_parentPOS)
...
def update_ttable(filename):
	...
	with open(filename) as f:
		for i, line in enumerate(f):
			...
			features = np.append(np.append(np.append(np.append(np.append(np.append(np.append(first_features, zeros_prev), zeros_Next), zeros_other), zeros_prev_POS), zeros_Next_POS), zeros_parentrel), zeros_parentPOS)
