...
parser.add_argument('--input', '-i', default='data/sample2000-2.input')
parser.add_argument('--ttable', '-t', default='data/ttable')
parser.add_argument('--refs', '-r', default='data/sample2000-2.refs')
...
weights = {'log_prob_tgs': .25, "log_prob_sgt": .25, "log_lex_prob_tgs": .25, "log_lex_prob_sgt": .25}
...
for iters in range(iterations):
	...
	w = np.subtract(w, (alpha * total_gradient))
